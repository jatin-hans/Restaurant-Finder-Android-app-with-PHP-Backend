...
if(isset($_SESSION['uname'])){
    ...
    <head>
        ...
        <title>Restaurant Admin | Add Images</title>
        ...
        <link rel="stylesheet" href="assets/css/apps/documents.css">
    ...
    include 'include/addresimage.php';
    ...
    ?>
        ...
        <script src="assets/js/apps/documents.js"></script>
        <script>
