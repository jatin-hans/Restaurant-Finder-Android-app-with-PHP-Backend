    ...
    <div class="modal-body">
        ...
        <div class="row" style="color: black;">
            <div class="col-lg-8 form-group">
                ...
                <input type="text" value="" style="color: #62A8EA;" class="form-control" name="menu" placeholder="Enter Dish Name" required="">
            </div>
              <div class="col-lg-8 form-group">
                <label>Price</label>
                <input type="text" value="" style="color: #62A8EA;" class="form-control" name="menu1" placeholder="Enter Price" required="">
            </div>
            <div class="col-lg-8 form-group">
                <input type="file" value="" style="color: #62A8EA;" class="form-control" name="image1" required="">
            </div>
     ...
     //   $id2=$_SESSION['new_id'];
      ...
      $qur=mysqli_query($con,"select * from adminlogin WHERE Username='$rit'");
        ...
        <div class="modal-footer">
            <button class="btn btn-primary" name="addmenu" type="submit" >Add Dish</button>
        </div>
        <div class="col-lg-8 form-group">
